...
public class Acide {
	 ...
	 * de l'acide aminee.
	 * 
	 * Ex: G[0] retourne les acides aminees possible
	 * lorsque G est en premiere position du codon.
	 * */
	private static AcideAmine[][] A = {
						{AcideAmine.ASN,AcideAmine.ILE,AcideAmine.LYS,AcideAmine.MET,
	...
	private static AcideAmine[][] G = {
							{AcideAmine.ALA,AcideAmine.ASP,AcideAmine.GLU,AcideAmine.GLY,
								AcideAmine.VAL},
	...
	private static AcideAmine[][] U = {
							{AcideAmine.CYS,AcideAmine.LEU,AcideAmine.PHE,AcideAmine.PYL,
	...
	private static AcideAmine[][] C = {
							{AcideAmine.LEU,AcideAmine.PRO,AcideAmine.HIS,AcideAmine.GLN,
								AcideAmine.ARG},
	 ...
	 * 		
	 * */
	protected static AcideAmine acide(Nucleotide[]codon){
		AcideAmine acide = null;
		ArrayList <AcideAmine> acides = new ArrayList<>();
		ArrayList <AcideAmine> acides_temp = new ArrayList<>();
